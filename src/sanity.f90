module mod_sanity
  ...
  subroutine test_sanity(ng,n,dims,stop_type,cbcvel,cbcpre,bcvel,bcpre,is_forced, &
    ...
    !call chk_solvers(ng,n,dli,dzci_g,dzfi_g,dzci,dzfi,cbcvel,cbcpre,bcvel,bcpre,passed)
  ...
  !
  subroutine chk_solvers(ng,n,dli,dzci_g,dzfi_g,dzci,dzfi,cbcvel,cbcpre,bcvel,bcpre,passed)
  implicit none
  integer , intent(in), dimension(3) :: ng,n
  real(rp), intent(in), dimension(3) :: dli
  real(rp), intent(in), dimension(0:) :: dzci_g,dzfi_g,dzci,dzfi
